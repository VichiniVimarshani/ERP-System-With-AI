...
const TeamAddModal: FC<ICustomerEditModalProps> = ({ id, isOpen, setIsOpen }) => {
    ...
    const [projects, setPoject] = useState<Project>();
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                axios
                    .get(`http://localhost:8090/project/${id}`)
                    .then((res: any) => {
                        setPoject(res.data)
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            const res: any = putservice(`project/${id}`, project)
            if (res) {
                Swal.fire({
                    icon: 'success',
                    title: 'Success',
        ...
        <Modal isOpen={isOpen} setIsOpen={setIsOpen} size='xl' titleId={id}>
            ...
            <ModalBody className='px-4'>
                ...
                <div className='row g-4'>
                    ...
                    <FormGroup id='projectName' label='Project Name' onChange={(e: any) => { project.projectName = e.target.value }} className='col-md-6'>
                        <Input
                    ...
                    <FormGroup id='team' label='Select Team'  onChange={(e: any) => { project.team = e.target.value }}className='col-md-6'>
                        <Input
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                ...
                                                >
                                                    {
                                                        team.filter((val) => {
                                                            if (project?.teamId.includes(val._id)) {
                                                                return val
                                                            }
